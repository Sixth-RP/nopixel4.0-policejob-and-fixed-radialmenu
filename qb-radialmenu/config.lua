...
rootMenuConfig =  {
    ...
    },
    {
        ...
        subMenus = {"general:givenum", "drug:sell", "general:givekey"}
    },
    {
        id = "Interaction",
        ...
        subMenus = {"general:cuff", "general:uncuff", "general:rob", "general:playerinvehicle", "general:playeroutvehicle", }
    },
    {
        id = "copDead",
         displayName = "11-A",
    ...
    {    
        ...
        subMenus = {"police:mdt", "general:cuff", "general:uncuff", "police:seizecash", "police:takedriverlicense", "police:statuscheck", "police:searchplayer", "police:jail", "police:takeoffmask" }
    },
    {    
        id = "PoliceObjects",
...
},
{
    ...
    {   
        ...
        subMenus = {"vehicle:carmenu", "vehicle:park", "vehicle:garage"}
    },
    {
...
newSubMenus = { -- NOTE basicly, what will be happen after clicking these buttons and icon of them
    ...
    ["expressions:angry"] = {
        ...
        functionName = "wsemotes:exp1",
    },
    ["expressions:drunk"] = {
        title="Drunk",
        icon="#expressions-drunk",
        functionName = "wsemotes:exp2",
    },
    ["expressions:dumb"] = {
        title="Dumb",
        icon="#expressions-dumb",
        functionName = "wsemotes:exp3",
    },
    ["expressions:electrocuted"] = {
        title="Electrocuted",
        icon="#expressions-electrocuted",
        functionName = "wsemotes:exp4",
    },
    ["expressions:grumpy"] = {
        title="Grumpy",
        icon="#expressions-grumpy",
        functionName = "wsemotes:exp5",
    },
    ["expressions:happy"] = {
        title="Happy",
        icon="#expressions-happy",
        functionName = "wsemotes:exp8",
    },
    ["expressions:injured"] = {
        title="Injured",
        icon="#expressions-injured",
        functionName = "wsemotes:exp9",
    },
    ["expressions:joyful"] = {
        title="Joyful",
        icon="#expressions-joyful",
        functionName = "wsemotes:exp10",
    },
    ["expressions:mouthbreather"] = {
        title="Mouth Breather",
        icon="#expressions-mouthbreather",
        functionName = "wsemotes:exp11",
    },
    ["expressions:shocked"]  = {
        title="Shocked",
        icon="#expressions-shocked",
        functionName = "wsemotes:exp12",
    },
    ["expressions:sleeping"]  = {
        title="Sleeping",
        icon="#expressions-sleeping",
        functionName = "wsemotes:exp13",
    },
    ["expressions:smug"]  = {
        title="smug",
        icon="#expressions-smug",
        functionName = "wsemotes:exp14",
    },
    ["expressions:speculative"]  = {
        title="Speculative",
        icon="#expressions-speculative",
        functionName = "wsemotes:exp15",
    },
    ["expressions:stressed"]  = {
        title="Stressed",
        icon="#expressions-stressed",
        functionName = "wsemotes:exp16",
    },
    ["expressions:sulking"]  = {
        title="Sulking",
        icon="#expressions-sulking",
        functionName = "wsemotes:exp17",
    },
    ["expressions:weird"]  = {
        title="Weird",
        icon="#expressions-weird",
        functionName = "wsemotes:exp18",
    },
    ["expressions:weird2"]  = {
        title="Weird2",
        icon="#expressions-weird2",
        functionName = "wsemotes:exp19",
    },
    ['blips:gasstations'] = {
        title = "Gas Station",
...
['police:spawn2'] = {
    ...
    ['k9:follow'] = {
        title = "Follow",
        icon = "#k9-follow",
        functionName = "wsemotes-k9:Follow"
    },
    ['k9:vehicle'] = {
        title = "Get In/Out",
        icon = "#k9-vehicle",
        functionName = "wsemotes-k9:EnterVeh"
    },
    ['k9:sit'] = {
        title = "Sit",
        icon = "#k9-sit",
        functionName = "wsemotes-k9:Sit"
    },
    ['k9:lay'] = {
        title = "Lay",
        icon = "#k9-lay",
        functionName = "wsemotes-k9:laydown"
    },
    ['k9:stand'] = {
        title = "Stand",
        icon = "#k9-stand",
    ...
    ['k9:sniff'] = {
        title = "Sniff Person",
        icon = "#k9-sniff",
        functionName = "wsemotes-k9:searchdude"
    },
    ['k9:sniffvehicle'] = {
        title = "Sniff Vehicle",
        icon = "#k9-sniff-vehicle",
        functionName = "wsemotes-k9:searchcar"
    },
    ['k9:huntfind'] = {
        title = "Search Area",
        icon = "#k9-huntfind",
        functionName = "wsemotes-k9:searcharea"
    },
    -- Vehicle parking and garage
    ['vehicle:carmenu'] = {
        title = "Car Menu",
        icon = "#vehicle-options-vehicle",
